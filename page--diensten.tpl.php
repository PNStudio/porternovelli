  ...
  <div id="page">
    <div id="header">
      ...
      <ul class='social'>
        ...
        <li class='flickr'><a href='http://www.flickr.com/people/porternovellinl/' name='flickr'>Flickr</a></li>
    ...
    <?php endif; ?>
    <?php print $messages; ?>
    <div id="main-wrapper-diensten-pagina">
    <h2>Diensten</h2>
    
    
    <?php print $new_disciplines; ?>
      <div id="disciplines">
        <div id="nav_disciplines"> <?php print render($page['nav_disciplines']); ?></div>
          <div id="disciplines_content"> 
          <?php $node = node_load($disciplines);
				$nodeView = node_view($node, 'full');
				echo '<div id="nodetitle">';
				print $node->title;
				echo '</div>';
       ...
       <div id="specialties">
        <div id="nav_specialties"> <?php print render($page['nav_specialties']); ?></div>
          <div id="specialties_content"> 
           <?php $node = node_load($specialty);
				$nodeView = node_view($node, 'full');
				echo '<div id="nodetitle">';
				print $node->title;
				echo '</div>';
